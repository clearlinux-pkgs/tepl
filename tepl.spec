...
Source0  : https://download.gnome.org/sources/tepl/6.2/tepl-6.2.0.tar.xz
...
%prep
%setup -q -n tepl-6.2.0
cd %{_builddir}/tepl-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667446147
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libtepl-6.so.1
/usr/lib64/libtepl-6.so.1.0.0
