...
Source0  : https://download.gnome.org/sources/tepl/6.00/tepl-6.00.0.tar.xz
...
%prep
%setup -q -n tepl-6.00.0
cd %{_builddir}/tepl-6.00.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619125312
...
cp %{_builddir}/tepl-6.00.0/LICENSES/LGPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/tepl/757b86330df80f81143d5916b3e92b4bcb1b1890
