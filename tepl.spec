...
Source0  : https://download.gnome.org/sources/tepl/6.1/tepl-6.1.1.tar.xz
...
%prep
%setup -q -n tepl-6.1.1
cd %{_builddir}/tepl-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655137666
...
cp %{_builddir}/tepl-6.1.1/LICENSES/LGPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/tepl/757b86330df80f81143d5916b3e92b4bcb1b1890
...
/usr/share/gtk-doc/html/tepl-6/preparation.html
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libtepl-6.so.0
/usr/lib64/libtepl-6.so.0.0.0
